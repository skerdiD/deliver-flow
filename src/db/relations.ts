...
export const clientInvitationsRelations = relations(
  ...
  ({ one }) => ({
    ...
    workspace: one(workspaces, {
      fields: [clientInvitations.workspaceId],
      references: [workspaces.id],
    }),
...
export const projectActivityRelations = relations(
  ...
  ({ one }) => ({
    ...
    workspace: one(workspaces, {
      fields: [projectActivity.workspaceId],
      references: [workspaces.id],
    }),
    actor: one(profiles, {
...
export const projectViewEventsRelations = relations(
  ...
  ({ one }) => ({
    ...
    workspace: one(workspaces, {
      fields: [projectViewEvents.workspaceId],
      references: [workspaces.id],
    }),
    client: one(clients, {
...
export const projectAssignmentsRelations = relations(
  ...
  ({ one }) => ({
    ...
    workspace: one(workspaces, {
      fields: [projectAssignments.workspaceId],
      references: [workspaces.id],
    }),
    client: one(clients, {
...
export const projectUpdatesRelations = relations(projectUpdates, ({ one }) => ({
  workspace: one(workspaces, {
    fields: [projectUpdates.workspaceId],
    references: [workspaces.id],
  }),
  project: one(projects, {
...
export const projectFilesRelations = relations(projectFiles, ({ one }) => ({
  workspace: one(workspaces, {
    fields: [projectFiles.workspaceId],
    references: [workspaces.id],
  }),
  project: one(projects, {
