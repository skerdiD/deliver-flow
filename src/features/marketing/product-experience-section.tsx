      ...
      <MarketingContainer>
        <MarketingReveal>
          <SectionHeading
            ...
            description="DeliverFlow turns the signals that usually live across inboxes, folders, and spreadsheets into one composed delivery view."
            align="center"
          />
        </MarketingReveal>
          ...
          <article className="marketing-card relative overflow-hidden rounded-[1.75rem] border border-slate-200 bg-slate-50 p-5 lg:col-span-7 lg:row-span-2 sm:p-7">
            <div className="max-w-lg">
              ...
              <h3 className="mt-2 text-2xl font-semibold tracking-[-0.04em]">
                A professional home for every project.
              </h3>
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Clients can follow progress, review the current milestone, find
                files, and respond without asking for another status update.
              </p>
            </div>
            <ProductWindow
              label="CLIENT PORTAL"
              title="Northstar · Website redesign"
              className="mt-7 translate-x-2 shadow-[0_22px_55px_-35px_rgba(15,23,42,0.55)] sm:translate-x-7"
            >
                ...
                <div className="flex items-center justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-1 text-xs text-slate-500">
                      Everything the client needs in one view
                    </p>
                  </div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <p className="text-xs font-semibold">
                          Homepage design, version 3
                        </p>
                        <p className="text-[0.68rem] text-slate-500">
                          Shared today at 10:42
                        </p>
                      </div>
                    </div>
                    <span className="hidden rounded-lg border border-slate-200 px-2.5 py-1.5 text-[0.68rem] font-semibold text-slate-700 sm:block">
                      Review
                    </span>
                  </div>
                </div>
          ...
          <article className="marketing-card rounded-[1.75rem] border border-blue-200 bg-blue-50/70 p-5 lg:col-span-5 sm:p-7">
            ...
            <div className="mt-6 rounded-2xl border border-blue-100 bg-white p-4 shadow-sm">
              ...
              <div className="mt-3 grid grid-cols-2 gap-2">
                <span className="rounded-lg bg-slate-950 px-2 py-2 text-center text-[0.68rem] font-semibold text-white">
                  Approve
                </span>
                <span className="rounded-lg border border-slate-200 px-2 py-2 text-center text-[0.68rem] font-semibold text-slate-700">
                  Request changes
                </span>
              </div>
            </div>
            ...
            <div className="grid gap-8 lg:grid-cols-[0.72fr_1.28fr] lg:items-center">
              <div>
                ...
                <p className="mt-3 max-w-lg text-sm leading-6 text-slate-300">
                  An action-oriented dashboard brings open feedback, waiting
                  approvals, project progress, and payment status into focus.
                </p>
...
function DarkMetric({
  ...
  return (
    <div className="rounded-xl border border-white/10 bg-slate-900 p-3.5">
      ...
      <p className="mt-1 text-[0.65rem] text-slate-400">{meta}</p>
    </div>
  );
}
  ...
  return (
    <div className="flex items-center gap-3 rounded-xl border border-white/10 bg-slate-900 p-3">
      ...
      <div className="min-w-0">
        ...
        <p className="truncate text-[0.68rem] text-slate-400">{project}</p>
      </div>
    </div>
  );
}
