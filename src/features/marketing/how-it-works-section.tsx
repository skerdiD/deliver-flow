      ...
      <MarketingContainer>
        <MarketingReveal>
          <SectionHeading
            ...
            description="Each step stays connected, so your team can see what is moving and clients know what comes next. Communication stays clear without adding a heavyweight project-management tool."
            className="max-w-3xl"
          />
        </MarketingReveal>
            ...
            <div className="grid gap-4 lg:grid-cols-[0.66fr_1.34fr]">
              <div className="rounded-[1.25rem] bg-slate-950 p-5 text-white sm:p-6">
                ...
                <h3 className="mt-3 max-w-md text-2xl font-semibold leading-tight tracking-[-0.04em]">
                  Every project update has a clear next step.
                </h3>
                <p className="mt-3 max-w-lg text-sm leading-6 text-slate-300">
                  Files, comments, approval requests, and payments stay on the
  ...
  return (
    <div className="relative flex gap-3 py-2.5">
      ...
      <div className="min-w-0 flex-1 sm:flex sm:items-start sm:justify-between sm:gap-4">
        ...
        <span
          className={`mt-1 inline-flex rounded-full px-2 py-1 text-[0.7rem] font-semibold sm:mt-0 ${current ? "bg-blue-50 text-blue-700" : "bg-slate-100 text-slate-600"}`}
        >
          {status}
        </span>
      </div>
